...
function Tv2() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`${BaseUrl}/upload/tv2`, formData, {
                headers: {
    ...
    const fetchVideos = async () => {
        try {
            const response = await axios.get(`${BaseUrl}/videos/tv2`);
    ...
    const handleDelete = async (filename) => {
        try {
            const response = await axios.delete(`${BaseUrl}/videos/tv2/${filename}`);
        ...
        <Container maxWidth="md">
            ...
            <Grid item >
                <Button
                    ...
                    variant={"outlined"}
                    onClick={() => {
                        window.location.href = 'https://garagestreet.com.tr/garage2';
                    }}
                >
                    Televizyon 2 yi  İzle
                </Button>
            </Grid>
        </Container>
    );
