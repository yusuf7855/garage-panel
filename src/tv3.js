...
function Tv3() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`${BaseUrl}/upload/tv3`, formData, {
                headers: {
    ...
    const handleDelete = async (filename) => {
        try {
            const response = await axios.delete(`${BaseUrl}/videos/tv3/${filename}`);
        ...
        <Container maxWidth="md">
            ...
            <Grid item >
                <Button
                    ...
                    variant={"outlined"}
                    onClick={() => {
                        window.location.href = 'https://garagestreet.com.tr/garage3';
                    }}
                >
                    Televizyonu 3 ü İzle
                </Button>
            </Grid>
        </Container>
    );
