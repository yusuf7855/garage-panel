...
function Tv4() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(`${BaseUrl}/upload/tv4`, formData, {
                headers: {
    ...
    const fetchVideos = async () => {
        try {
            const response = await axios.get(`${BaseUrl}/videos/tv4`);
    ...
    const handleDelete = async (filename) => {
        try {
            const response = await axios.delete(`${BaseUrl}/videos/tv4/${filename}`);
        ...
        <Container maxWidth="md">
            ...
            <Grid item >
                <Button
                    ...
                    variant={"outlined"}
                    onClick={() => {
                        window.location.href = 'https://garagestreet.com.tr/garage4';
                    }}
                >
                    Televizyonu 4 ü İzle
                </Button>
            </Grid>
        </Container>
    );
